...
public class HowTo2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn = (ImageButton) findViewById(R.id.ib_swipe_left2);
        ...
        btn = (ImageButton) findViewById(R.id.ib_swipe_right2);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
    ...
    {
        HearingScreeningApplication.activityIntentSwitch(new MainMenuActivity(), HowTo2Activity.this, R.anim.push_right_out, R.anim.push_right_in2);
    }
